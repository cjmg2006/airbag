...
//Print EPC
void printEPC(byte tags[], int index) { 
  Serial.print(F(" epc["));
  for (byte x = 0 ; x < 12 ; x++)
  {
    if (tags[x * index] < 0x10) Serial.print(F("0"));
    Serial.print(tags[x * index], HEX);
    Serial.print(F(" "));
  }
  Serial.println(F("]"));
...
//  for (byte x = 0 ; x < 36 ; x++)
//  {
//    if (tags[x] < 0x10) Serial.print(F("0"));
//    Serial.print(tags[x], HEX);
//    Serial.print(F(" "));
//  }
//  Serial.println(F("]"));
