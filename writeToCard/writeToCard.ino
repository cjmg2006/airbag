...
// TO DO: Write to 3 different cards and understand that they are all part of 1 unique identity. 
...
//            code << blockNum;
            ...
            for(int j = 0; j < 16; j++) {
              blockcontent[j] = blockNum + nonce; 
            } 
            writeBlock(blockNum, blockcontent); 
        }

        nonce++; 
        numCardsWritten++; 
         
//         writeBlock(block2, blockcontent2);
